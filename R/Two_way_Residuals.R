Two_way_Residuals <- function(Y, n_prefectures, year, age, n_populations)
{
    FMP <- Two_way_median_polish(Y, n_prefectures=n_prefectures, year=year, age=age, n_populations=n_populations)
    Two_FGE = FMP$grand_effect
    Two_FRE = FMP$row_effect
    Two_FCE = FMP$col_effect
